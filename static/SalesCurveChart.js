function fetchDataAndUpdateSalesCurveChart() {
    fetch('/get_Sales_Curve')
        .then(response => response.json())
        .then(data => {
            updateSalesCurveChart(data);
        })
        .catch(error => console.error('Error:', error))
}

function updateSalesCurveChart(data00) {
...
document.addEventListener("DOMContentLoaded", function() {
    fetchDataAndUpdateSalesCurveChart();
});